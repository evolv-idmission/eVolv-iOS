...
@interface AutofillBackController ()

@end

@implementation AutofillBackController {
    //UILabel *leftLabel;
    UILabel *titleLabel;
...
//    [titleLabel setText:[[NSString alloc]initWithFormat:@"%@",[ArrayObjectController getTitleStringForDictionary]]];
    [titleLabel setText:[LabelUtils getLabelForKey:@"auto_fill_back_tab"]];
    ...
    [mrzRetryCountTextField setText:[self retrieveSetting:@"mrz_retry_count" defaultValue:mrzRetryCountThreshold]];
    
    [mrzBarcodeRetryCountTextField setDelegate:(id)self];
    [mrzBarcodeRetryCountTextField setKeyboardType:UIKeyboardTypeNumberPad];
    [mrzBarcodeRetryCountTextField setText:[self retrieveSetting:@"mrz_barcode_retry_count" defaultValue:mrzBarcodeRetryCountThreshold]];
...
- (void)viewOnTouch:(UITapGestureRecognizer *)recognizer
{
    ...
    [nsDict setObject:@"BACK" forKey:@"id_side"];
...
-(void)saveButton:(UIButton*)button {
    [self saveSetting:@"mrz_retry_count" value:[mrzRetryCountTextField text]];
    [self saveSetting:@"mrz_barcode_retry_count" value:[mrzRetryCountTextField text]];
    [self configBtnClickMethod];
