...
@interface IDCaptureFrontController ()

@end

@implementation IDCaptureFrontController {
    UILabel *titleLabel;
    bool isVisible;
...
- (void)viewDidLoad {
    ...
    [titleLabel setText:[LabelUtils getLabelForKey:@"capture_id_front_tab"]];
    ...
    NSString *capturebuttontime = [self retrieveSetting:@"capturebuttontime" defaultValue:[@(mCaptureButtonTime) stringValue]];
     NSString *barcodeScanLimit_NSString = [self retrieveSetting:@"barcodeScanLimit_Front" defaultValue:[@(mbarcodeScanLimitValue) stringValue]];
    NSString *mrzScanLimit_NSString = [self retrieveSetting:@"mrzScanLimit_Front" defaultValue:[@(mMrzScanLimit) stringValue]];
    NSString *mrzAndBarcodeScanLimit_NSString = [self retrieveSetting:@"mrzAndbarcodeScanLimit_Front" defaultValue:[@(mMrzAndBarcodeScanLimit) stringValue]];
...
-(void)saveButton:(UIButton*)button {
    ...
    [self saveSetting:@"barcodeScanLimit_Front" value:[NSString stringWithFormat:@"%d", BarcodeScanLimit]];
    [self saveSetting:@"mrzScanLimit_Front" value:[NSString stringWithFormat:@"%d", MrzScanLimit]];
    [self saveSetting:@"mrzAndbarcodeScanLimit_Front" value:[NSString stringWithFormat:@"%d", MrzAndBarcodeScanLimit]];
...
-(void)resetButton:(UIButton*)button {
    ...
    [self saveSetting:@"barcodeScanLimit_Front" value:[NSString stringWithFormat:@"%@", [barcodeScanLimitTextField text]]];
    [self saveSetting:@"mrzScanLimit_Front" value:[NSString stringWithFormat:@"%@", [mrzRetryCountTextField text]]];
    [self saveSetting:@"mrzAndbarcodeScanLimit_Front" value:[NSString stringWithFormat:@"%@", [mrzBarcodeRetryCountTextField text]]];
...
//        [barcodeScorolledData setText:@"jfhjkfhjkv jdnvnvn ncnnvnv nvnkvnvnvnv vnvnkjasknnvn lnvnfnvnmv nvfnmfnknkmfnkm nvnvmnvnmvmnvmn nkvnkvnvnmvmnvn nvnmkvnmvmnv"];
...
-(void)nextButton:(UIButton*)button {
    ...
    [controller setNextViewController:storyBoardId];
}
...
//    [AppItSDK captureFrontImage:@"FRONT" instance:[ArrayObjectController getPageDelegate] titleImage:titleImageFace additionalDictionary:[AppItSDK getAdditionalDataDictionary] instructionimage:nil fieldName:nil uiConfigDictionary:nsDict];
    ...
    [AppItSDK captureFrontImage:[ArrayObjectController getPageDelegate] additionalDictionary:[AppItSDK getAdditionalDataDictionary] uiConfigDictionary:nsDict];
}
...
-(void)setWrapUILabel:(UILabel*)labelText{
    NSString *language = [self retrieveSetting:@"language" defaultValue:@"en"];
    if([language isEqualToString:@"es"] || [language isEqualToString:@"my"]){
        [labelText sizeToFit];
    }
}
