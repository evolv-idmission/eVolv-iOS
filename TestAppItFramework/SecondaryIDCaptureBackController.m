//
//  SecondaryIDCaptureBackController.m
//  AppItDepedency
//
...
@interface SecondaryIDCaptureBackController ()

@end

@implementation SecondaryIDCaptureBackController {
    UILabel *titleLabel;
    ...
    *retryButtonBorderTextField, *retryButtonBorderTransTextField, *confirmButtonStyleTextField, *confirmButtonStyleTransTextField, *headerSizeTextField, *textSizeTextField, *headerFontStyleTextField, *headerTextColorTextField, *headerTextColorTransTextField, *idCaptureBorderLabelTextField;
    
    //Configuration Radio Btn
    UIButton *portraitRadioBtn, *landscapeRadioBtn, *noInstRadioBtn, *yesInstRadioBtn, *idCaptureTitleCheckBox, *idCaptureHintMsgCheckBox, *idTitleImgCheckBox;
...
-(void)viewDidAppear:(BOOL)animated {
    ...
    if([ArrayObjectController getHideSecondaryIDBack]) {
        [backGroundWhiteView setAlpha:0.5];
        [recaptureButton setAlpha:0.5];
        [backGroundWhiteView setUserInteractionEnabled:false];
        [recaptureButton setUserInteractionEnabled:false];
    } else {
        [backGroundWhiteView setAlpha:1];
        [recaptureButton setAlpha:1];
        [backGroundWhiteView setUserInteractionEnabled:true];
        [recaptureButton setUserInteractionEnabled:true];
    }
}
...
- (void)viewDidLoad {
    ...
    [titleLabel setText:[LabelUtils getLabelForKey:@"secondary_id_back_tab"]];
...
-(void)captureCameraAPICall{
    ...
    [AppItSDK captureSecondaryBackImage:[ArrayObjectController getPageDelegate] additionalDictionary:[AppItSDK getAdditionalDataDictionary] uiConfigDictionary:nsDict];
...
-(void)captureResponse : (NSMutableDictionary*) result {
    ...
    if(nil != front){
        ...
        NSData* data = [[NSData alloc] initWithBase64EncodedString:back_secondary options:0];
        UIImage* image = [UIImage imageWithData:data];
