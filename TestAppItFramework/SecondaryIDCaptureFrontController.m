//
//  SecondaryIDCaptureFrontController.m
//  AppItDepedency
//
...
@interface SecondaryIDCaptureFrontController ()

@end

@implementation SecondaryIDCaptureFrontController {
    UILabel *titleLabel;
    bool isVisible;
...
- (void)viewDidLoad {
    ...
    [titleLabel setText:[LabelUtils getLabelForKey:@"secondary_id_front_tab"]];
...
-(void)captureCameraAPICall{
    ...
    [AppItSDK captureSecondaryFrontImage:[ArrayObjectController getPageDelegate] additionalDictionary:[AppItSDK getAdditionalDataDictionary] uiConfigDictionary:nsDict];
}
...
-(void)captureResponse : (NSMutableDictionary*) result {
    ...
    if(nil != front_secondary){
        NSData* data = [[NSData alloc] initWithBase64EncodedString:front_secondary options:0];
