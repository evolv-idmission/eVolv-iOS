...
@interface IdFaceDetailsViewController ()

@end

@implementation IdFaceDetailsViewController {
...
//        secondaryCaptureCGRect = [self secoundryIDCaptureChanges:secondaryCaptureCGRect];
//    }
...
-(CGRect) secoundryIDCaptureChanges:(CGRect )rect {
    
    CGFloat width = [UIScreen mainScreen].bounds.size.width;
    CGFloat height = [UIScreen mainScreen].bounds.size.height;
    
    //Secondary Select ID Type
    selectIdTypeTextField_sec = [[UITextField alloc] initWithFrame:CGRectMake(rect.origin.x, rect.origin.y + rect.size.height + (height/100)*5 , (width/100)*86, (height/100)*7)];
...
-(void) nextButtonChanges {
    ...
    //    }
        ...
        if(![NSStringUtilsDemo stringIsNilOrEmpty:[selectIdStateTextField_sec text]]) {
